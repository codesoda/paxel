...
- Digest: `sha256:cfb6abaf04e399fcec7f3f5e02892c646bb603c70637c6632c7ebb14065b2925`
- Source revision: `9f33b0165847743b5fa5d54a3ff38a5aa038ca11`

Changes from `0.3.44.5`:

- Bumped the packaged client version to `0.3.44.6`; the extracted Rails filesystem otherwise matches the previous snapshot.

## 0.3.44.5

Image:

- Digest: `sha256:b11111b7c38b33a85e7e1b4e41451f0aa968ebd566acdd01f345084fbbea2ce8`
- Source revision: `6c2732c9a443269a31dd23fceb44b33d5fb9e9e8`

Changes from `0.3.44.4`:

- Bumped the packaged client version to `0.3.44.5`; the extracted Rails filesystem otherwise matches the previous snapshot.

## 0.3.44.4

Image:

- Digest: `sha256:f480a2ac805b8353c1627a84136d507aebd337a88fed992a5ad19d12e1b3e3b5`
- Source revision: `89f541abd07a1a63bd028b7b545fddccb6b4778e`

Changes from `0.3.44.3`:

- Bumped the packaged client version to `0.3.44.4`; the extracted Rails filesystem otherwise matches the previous snapshot.
